 ...
 */
export default function GoogleSignInButton({ role, onSuccess, label = 'Continue with Google' }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-slate-300 bg-white hover:bg-slate-50 transition disabled:opacity-60 disabled:cursor-not-allowed text-sm font-medium"
    >
